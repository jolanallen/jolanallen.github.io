function array_random(items, predicate) {
...
export { arrayOfObjUniq, array_flatten, array_random, array_remove_empty, array_shuffle, array_shuffle_swap, array_unique, rand };
