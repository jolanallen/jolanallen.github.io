 ...
 */
const toJSONBrowser = anyData => $parse(stringify(anyData));
/**
 * Parses a circular object from JSON.
 * @param anyData - The JSON string to parse.
 * @returns The parsed object.
 */
const fromJSONBrowser = anyData => parse($stringify(anyData));
/**
 ...
 */
function jsonStringifyWithCircularRefsBrowser(data) {
 ...
 * @returns The parsed object
 */
function jsonParseWithCircularRefsBrowser(data) {
  return parse(data);
}

exports.fromJSONBrowser = fromJSONBrowser;
exports.jsonParseWithCircularRefsBrowser = jsonParseWithCircularRefsBrowser;
exports.jsonStringifyWithCircularRefsBrowser = jsonStringifyWithCircularRefsBrowser;
exports.parseBrowser = parse;
exports.stringifyBrowser = stringify;
exports.toJSONBrowser = toJSONBrowser;
