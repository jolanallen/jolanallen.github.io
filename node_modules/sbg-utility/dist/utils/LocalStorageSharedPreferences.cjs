...
if (typeof localStorage === 'undefined' || localStorage === null) {
  ...
  if (typeof process !== 'undefined' && process.versions && process.versions.node) {
    globalThis.localStorage = new nodeLocalstorage.LocalStorage('./scratch');
  }
}
/**
...
exports.LocalStorageSharedPreferences = LocalStorageSharedPreferences;
exports.default = LocalStorageSharedPreferences;
