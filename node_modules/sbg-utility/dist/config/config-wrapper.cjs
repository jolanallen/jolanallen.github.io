...
require('../utils/filemanager/path-utility.cjs');
require('../utils/logger.cjs');
var writefile = require('../utils/filemanager/writefile.cjs');

var _documentCurrentScript = typeof document !== 'undefined' ? document.currentScript : null;
const __filename$1 = url.fileURLToPath((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('config/config-wrapper.cjs', document.baseURI).href)));
