---
title: À propos de Jolan Allen (ThePrintor)
date: 2025-02-23
tags: [About, Cybersécurité, Alternance]
keywords: 'Alternance Cybersécurité, Jolan Allen, ThePrintor, Pentest Montpellier, GRC, Infrastructure Sécurisée, Ynov Montpellier'
description: Jolan Allen (ThePrintor), étudiant en Bachelor Cybersécurité à Montpellier Ynov Campus. Recherche une alternance de 36 mois à partir de juillet 2026.
...
- **Gestion des Risques** : Rédaction de PSSI, Chartes IT et plans de résilience (PCA/PRA).
- **Architecture & Défense** : Durcissement (Hardening) système (BitLocker, MFA) et sécurisation réseau.
- **Offensive** : Tests d'intrusion (Pentest) sur les applications Web métier.

**Développeur Polyvalent @ Association CyberV** *(07/2025 - Présent)*
- Développement Backend et création de bots Discord sécurisés pour la gestion de communauté.
...
- **Baccalauréat STI2D** (Mention Bien) : Spécialité Système d’Information Numérique.
...
| :--- | :--- |
| **Langages** | Rust, Golang, Python, Bash, C/C++, PowerShell |
| **Offensif** | Metasploit, BurpSuite, ZAP, Nmap, Nikto, Exegol |
| **Défensif** | Iptables, Fail2Ban, Hardening Windows/Linux |
| **Outils** | Docker, Git, Wireshark, Tcpdump |
